...
const debates: Map<string, Debate> = new Map([
  ...
  [
    "woman-001",
    {
      ...
      debaterA: {
        ...
        name: "Matt Walsh",
        position: "FOR",
        photoUrl: "/debaters/walsh.jpg",
      },
      debaterB: {
        id: "debater-butler",
        name: "Judith Butler",
        position: "AGAINST",
        photoUrl: "/debaters/butler.jpg",
      },
      votesA: 0,
      votesB: 0,
    },
  ...
  [
    ...
    {
      id: "ubi-001",
      title: "The US Should Support Universal Basic Income for All Citizens",
      topic: "Economics & Welfare",
      description:
        "Andrew Yang built a presidential run on UBI. Vivek Ramaswamy treats it as a work-disincentive trap. The audience decides whose framing wins.",
      scheduledAt: "2026-05-18T00:00:00Z",
      status: "upcoming",
      debaterA: {
        id: "debater-ramaswamy",
        name: "Vivek Ramaswamy",
        position: "AGAINST",
        photoUrl: "/debaters/ramaswamy.jpg",
      },
      debaterB: {
        id: "debater-yang",
        name: "Andrew Yang",
        position: "FOR",
        photoUrl: "/debaters/yang.jpg",
      },
      votesA: 0,
      votesB: 0,
    },
  ...
  [
    "defund-001",
    {
      ...
      debaterA: {
        ...
        name: "Ilhan Omar",
        position: "FOR",
        photoUrl: "/debaters/omar.jpg",
      },
      debaterB: {
        id: "debater-hegseth",
        name: "Pete Hegseth",
        position: "AGAINST",
        photoUrl: "/debaters/hegseth.jpg",
      },
      votesA: 0,
      votesB: 0,
    },
