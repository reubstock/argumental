    ...
    <>
      ...
      <div className="flex justify-between items-center px-1 gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={() => addA(1)}
            className="bg-yellow-400 hover:bg-yellow-300 text-black font-black text-xs uppercase px-3 py-2 rounded-lg transition"
          >
            $1
          </button>
          <button
            onClick={() => addA(5)}
            className="bg-green-500 hover:bg-green-400 text-white font-black text-xs uppercase px-3 py-2 rounded-lg transition"
          >
            $5
          </button>
        </div>
